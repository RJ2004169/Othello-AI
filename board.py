...
class Board:
    ...
    """ This class contains the details of the board and the game rules are also implemented. 
    Some functions required to calculate the state of the board are also defined here """
    ...
    def apply_move(self, move, color):
        ...
        if move in self.valid_moves:
            ...
            for i in range(1, 9):
                self.totalPiecesCaptured += self.flip(i, move, color)
                
        return self.totalPiecesCaptured;
